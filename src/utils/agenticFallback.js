import { loadPackSteps } from "../data/simulationData";
 ...
 */
export async function buildOfflineBeat(packId, turnOneBased, priorWorld) {
  const steps = await loadPackSteps(packId);
  if (!steps.length) {
